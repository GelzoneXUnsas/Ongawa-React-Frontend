        ...
        return (
            <div key={index} onClick={() => handleImageClick(image)}>
                {props.currentPage === "art" ? 
                    <img className="artImage object-cover w-48 h-40 flex-shrink-0 rounded-xl shadow-md lg:w-full lg:h-auto" src={artImages[image.id-1]} alt={image.description} /> 
                    :
                    <div className="coverImageAndText flex flex-col items-center font-title-lexend text-font-size-xs lg:text-body-overpass-base">
