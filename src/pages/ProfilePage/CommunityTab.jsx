              ...
              {communityData.interacted.map((item) => (
                <div key={item.id}>
                  ...
                  <div className="hidden md:grid grid-cols-12 gap-4 py-5 px-4 items-center">
                    <div className="col-span-4 text-white font-nova-square">
                      {item.name}
                    </div>
                    <div className="col-span-4 flex items-center justify-center">
                      ...
                      <span className="text-gray-400 font-nova-square">
                        {item.author}
                      </span>
                    </div>
                    <div className="col-span-2 text-center font-nova-square">
                      {item.comments}
                    </div>
                    <div className="col-span-2 text-center text-gray-300 font-nova-square">
                      {item.date}
                    </div>
                  </div>
                    ...
                    <div className="flex pb-2">
                      ...
                      <div className="flex-1">
                        <div className="text-white font-medium flex flex-wrap items-center pb-2">
                          <span className="font-nova-square">
                            {item.author}
                          </span>
                        ...
                        <div className="text-gray-300 text-sm leading-relaxed font-roboto">
                          {item.description}
                        </div>
                      </div>
                    </div>
              ...
              {communityData.created.map((item) => (
                <div key={item.id}>
                  ...
                  <div className="hidden md:grid grid-cols-12 gap-4 py-5 px-4 items-center">
                    ...
                    <div className="col-span-4 text-center h-8 font-nova-square">
                      {item.bookmarked}
                    </div>
                    <div className="col-span-2 text-center font-nova-square">
                      {item.comments}
                  ...
                  <div className="md:hidden bg-[#3A3559] rounded-lg p-4">
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex items-center space-x-4 font-nova-square">
