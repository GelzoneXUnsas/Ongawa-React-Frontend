...
import CommunityPage from "./pages/CommunityPage/CommunityPageRevised";
import ComingSoonPage from "./pages/ComingSoonPage/ComingSoonPage";

import Login from "./pages/Auth/authComponent";
        ...
        <div>
            <AuthProvider>
                ...
                <Routes>
                    ...
                    <Route
                        path="beatmaplisting"
                        element={<BeatmapListingPage />}
                    />
                    <Route
                        path="musicianlisting"
                        element={<MusicanListingPage />}
                    />
